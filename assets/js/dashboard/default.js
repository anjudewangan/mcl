(function ($) {
  ...
  var options = {
    series: [{
      name: 'Till Yesterday',
      data: [2, 15, 25, 20, 30, 26, 24]
    },
    {
      name: 'Today',
      data: [10, 25, 15, 16, 10, 14, 28]
    },
    {
      name: 'Total',
      data: [12, 30, 30, 36, 40, 40, 52]
    }
    ],
    chart: {
      height: 168,
    ...
    xaxis: {
      offsetX: 0,
      offsetY: 0,
      categories: ["Monday (22-02-23)", "Tuesday (23-02-23)", "Wednesday (24-02-23)", "Thusday (25-02-23)", "Friday (26-02-23)", "Saturday (27-02-23)", "Sunday (28-02-23)"],
      labels: {
        low: 0,
        offsetX: 0,
        show: false,
    ...
    colors: [TivoAdminConfig.success, TivoAdminConfig.primary, TivoAdminConfig.secondary],
  };
  ...
  var options = {
    series: [{
      ...
      data: [20, 40, 20, 65, 35, 30, 60, 35, 15, 20, 40, 20, 65, 35, 30]
    }, {
      name: 'Total Received',
      data: [30, 25, 10, 12, 13, 15, 10, 15, 10, 30, 25, 10, 12, 13, 15],
    },
    ],
    chart: {
      type: 'bar',
    ...
    xaxis: {
      categories: ['Amrapali', 'Argada', 'Barka', 'Bokaro', 'CCL', 'CRS', 'Dhori', 'Giridih', 'Hazari', 'Kathara', 'Kuju', 'MRS', 'N.K.', 'Piparwar', 'Rajhara'],
      offsetX: 0,
      offsetY: 0,
      axisBorder: {
        low: 0,
